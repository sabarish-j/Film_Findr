// API Configuration
const configuredServerUrl = import.meta.env.VITE_SERVER_BASE_URL || 'http://localhost:5000';
export const SERVER_BASE_URL = configuredServerUrl.replace(/\/+$/, '').replace(/\/api$/, '');
